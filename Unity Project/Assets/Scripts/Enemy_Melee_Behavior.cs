...
//Version of enemy that runs up and stabs player instead of shooting
public class Enemy_Melee_Behavior : MonoBehaviour {
	...
	public int targetingRange = 150;
	public int approachRange = 2;
	public int targetTimer = 30;
	public int nearbyEnemies;
	public float nearbyRange = 4;

	//shooting
	public int shootRange = 2;
...
//				hitColliders [i].SendMessage ("AddDamage");
	...
	//shoot if in range
	void shoot(){
		if (targetDistance < shootRange && targetDistance > -shootRange && Time.time > nextFire && targetDistance != 0){
